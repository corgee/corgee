...
class RetrievalEvaluator(Evaluator):
    ...
    def compute_metrics(self, model, corpus_model=None, corpus_embeddings: torch.Tensor = None, **kwargs) -> Dict[str, float]:
        ...
        kwargs = {
            ...
            **kwargs
        } if "show_progress_bar" in inspect.signature(model.encode).parameters else kwargs
