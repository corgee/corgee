...
class BertPreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, model_name, config, *inputs, **kwargs):
        ...
        load_return = model.load_state_dict(
            remap_state_dict(state_dict_from_pretrained(model_name), config, keep_only_bert=True), strict=False
        )
...
def remap_state_dict(state_dict, config: PretrainedConfig, keep_only_bert=False):
    """
